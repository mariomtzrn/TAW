<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    $al = new alumno();
    $reg = $al->update($matricula, $nombre, $id_carrera, $id_tutor);
...
<html lang="en">
  ...
  <body>
    ...
    <div class="ui main container" style="padding-top:10px;">
      <h1 class="ui header">Alumnos - Modificar alumno</h1>
      <form class="" action="" method="post">
        <div class="ui form" action="">
          <div class="three fields">
            <div class="field">
              <label>Matricula</label>
              <input type="text" name="matricula" value="<?php echo $alumno['matricula']; ?>">
            </div>
            <div class="field">
              <label>Nombre</label>
          ...
          <button type="submit" class="ui button" name="submit">Modificar alumno</button>
        </div>
      </form>
    </div>
