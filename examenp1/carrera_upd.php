<?php
  ...
  $carr = new carrera();
  $carreras = $carr->search($_GET['id']);

  if (isset($_POST['submit'])) {
    $nombre = $_POST['nombre'];
    #Crea el objeto de la clase alumno
    $al = new carrera();
    $reg = $al->update($nombre);
...
<html lang="en">
  ...
  <body>
    ...
    <div class="ui main container" style="padding-top:10px;">
      <h1 class="ui header">Carreras - Modificar carrera</h1>
      <form class="" action="" method="post">
        <div class="ui form" action="">
          ...
          <button type="submit" class="ui button" name="submit">Modificar carrera</button>
        </div>
      </form>
    </div>
